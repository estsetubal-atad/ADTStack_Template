...
It includes the **ADT Stack** for proposed exercises during class.
...
```console
$> git clone https://github.com/estsetubal-atad/ADTStack_Template.git <program-dir-name>
```
...
```console
$> git clone https://github.com/estsetubal-atad/ADTStack_Template.git MyStackCProgram
$> code MyOwnCProgram
```
